...
class WordGenerator {
    ...
    static let possibleWords = [
        "OCEAN", "RIVER", "STORM", "WOODS", "WAXEN",
        "SPANS", "EARTH", "GLADE", "GLASS", "TOWER",
        "CLOUD", "FLAME", "STONE", "METAL", "PLANT",
        "BLOOM", "GRAIN", "LEAFY", "MOSSY", "BERRY",
        "BRINE", "TIDES", "SHORE", "DELTA", "CREEK",
        "BRIAR", "VINES", "HEDGE", "FIELD", "WORLD"
    ]
    static func generateRandomWord() -> String? {
        // START YOUR CODE HERE
        let randomWord = possibleWords.randomElement()
        print("Generated word: \(randomWord!)")   // Debugging
        return randomWord
        // END YOUR CODE HERE
    }
}
